<!DOCTYPE html>
<!-- saved from url=(0018)https://bronew.ru/ -->
<html lang="ru" class=" ">
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="https://bronew.ru/images/favicon.png">
    <title>Бронев</title>
    <link href="./Бронев_files/style.css" rel="stylesheet">
    <link href="./Бронев_files/blue.css" id="theme" rel="stylesheet">
    <!--[if lt IE 9]>
    <script src="https://oss.maxcdn.com/libs/html5shiv/3.7.0/html5shiv.js"></script>
    <script src="https://oss.maxcdn.com/libs/respond.js/1.4.2/respond.min.js"></script>
    <![endif]-->
    <link href="./Бронев_files/print_style.css" rel="stylesheet">
    <link href="./Бронев_files/1671459199385-chunk-vendors.2cb4.css" rel="stylesheet">
    <style type="text/css">
        .vc-popover-content-wrapper[data-v-88de91da] {
            ...
            .vc-popover-content-wrapper[data-v-88de91da]:not(.is-interactive) {
                pointer-events: none
            }
        ...
        .vc-popover-content.direction-bottom[data-v-88de91da] {
            margin-top: var(--popover-vertical-content-offset)
        }

        .vc-popover-content.direction-top[data-v-88de91da] {
            margin-bottom: var(--popover-vertical-content-offset)
        }

        .vc-popover-content.direction-left[data-v-88de91da] {
            margin-right: var(--popover-horizontal-content-offset)
        }

        .vc-popover-content.direction-right[data-v-88de91da] {
            margin-left: var(--popover-horizontal-content-offset)
        }

        .vc-popover-caret[data-v-88de91da] {
            content: "";
            position: absolute;
            display: block;
            width: 12px;
        ...
        .vc-popover-caret.direction-bottom[data-v-88de91da] {
            top: 0
        }

        .vc-popover-caret.direction-bottom.align-left[data-v-88de91da] {
            transform: translateY(-50%) rotate(45deg)
        }

        .vc-popover-caret.direction-bottom.align-center[data-v-88de91da] {
            transform: translateX(-50%) translateY(-50%) rotate(45deg)
        }

        .vc-popover-caret.direction-bottom.align-right[data-v-88de91da] {
            transform: translateY(-50%) rotate(45deg)
        }

        .vc-popover-caret.direction-top[data-v-88de91da] {
            top: 100%
        }

        .vc-popover-caret.direction-top.align-left[data-v-88de91da] {
            transform: translateY(-50%) rotate(-135deg)
        }

        .vc-popover-caret.direction-top.align-center[data-v-88de91da] {
            transform: translateX(-50%) translateY(-50%) rotate(-135deg)
        }

        .vc-popover-caret.direction-top.align-right[data-v-88de91da] {
            transform: translateY(-50%) rotate(-135deg)
        }

        .vc-popover-caret.direction-left[data-v-88de91da] {
            left: 100%
        }

        .vc-popover-caret.direction-left.align-top[data-v-88de91da] {
            transform: translateX(-50%) rotate(135deg)
        }

        .vc-popover-caret.direction-left.align-middle[data-v-88de91da] {
            transform: translateY(-50%) translateX(-50%) rotate(135deg)
        }

        .vc-popover-caret.direction-left.align-bottom[data-v-88de91da] {
            transform: translateX(-50%) rotate(135deg)
        }

        .vc-popover-caret.direction-right[data-v-88de91da] {
            left: 0
        }

        .vc-popover-caret.direction-right.align-top[data-v-88de91da] {
            transform: translateX(-50%) rotate(-45deg)
        }

        .vc-popover-caret.direction-right.align-middle[data-v-88de91da] {
            transform: translateY(-50%) translateX(-50%) rotate(-45deg)
        }

        .vc-popover-caret.direction-right.align-bottom[data-v-88de91da] {
            transform: translateX(-50%) rotate(-45deg)
        }

        .vc-popover-caret.align-left[data-v-88de91da] {
            left: var(--popover-caret-horizontal-offset)
        }

        .vc-popover-caret.align-center[data-v-88de91da] {
            left: 50%
        }

        .vc-popover-caret.align-right[data-v-88de91da] {
            right: var(--popover-caret-horizontal-offset)
        }

        .vc-popover-caret.align-top[data-v-88de91da] {
            top: var(--popover-caret-vertical-offset)
        }

        .vc-popover-caret.align-middle[data-v-88de91da] {
            top: 50%
        }

        .vc-popover-caret.align-bottom[data-v-88de91da] {
            bottom: var(--popover-caret-vertical-offset)
        }

        .fade-enter-active[data-v-88de91da], .fade-leave-active[data-v-88de91da], .slide-fade-enter-active[data-v-88de91da], .slide-fade-leave-active[data-v-88de91da] {
            transition: all var(--popover-transition-time);
            pointer-events: none
        }

        .fade-enter[data-v-88de91da], .fade-leave-to[data-v-88de91da], .slide-fade-enter[data-v-88de91da], .slide-fade-leave-to[data-v-88de91da] {
            opacity: 0
        }

        .slide-fade-enter.direction-bottom[data-v-88de91da], .slide-fade-leave-to.direction-bottom[data-v-88de91da] {
            transform: translateY(calc(-1*var(--popover-slide-translation)))
        }

        .slide-fade-enter.direction-top[data-v-88de91da], .slide-fade-leave-to.direction-top[data-v-88de91da] {
            transform: translateY(var(--popover-slide-translation))
        }

        .slide-fade-enter.direction-left[data-v-88de91da], .slide-fade-leave-to.direction-left[data-v-88de91da] {
            transform: translateX(var(--popover-slide-translation))
        }

        .slide-fade-enter.direction-right[data-v-88de91da], .slide-fade-leave-to.direction-right[data-v-88de91da] {
            transform: translateX(calc(-1*var(--popover-slide-translation)))
        }
    </style>
    <style type="text/css">
        .vc-day-popover-row[data-v-d159ca94] {
            ...
            .vc-day-popover-row[data-v-d159ca94]:not(:first-child) {
                margin-top: 3px
            }

        .vc-day-popover-row-indicator[data-v-d159ca94] {
            display: flex;
        ...
        .vc-day-popover-row-indicator span[data-v-d159ca94] {
            transition: all var(--day-content-transition-time)
        }

        .vc-day-popover-row-content[data-v-d159ca94] {
            display: flex;
            align-items: center;
            flex-wrap: none;
            flex-grow: 1;
    ...
    <style type="text/css">
        ...
        .vc-day-box-left-center[data-v-47ef1cd6] {
            display: flex;
        ...
        .vc-day-box-right-center[data-v-47ef1cd6] {
            display: flex;
        ...
        .vc-day-box-center-bottom[data-v-47ef1cd6] {
            display: flex;
            justify-content: center;
        ...
        .vc-day-content[data-v-47ef1cd6] {
            ...
            .vc-day-content[data-v-47ef1cd6]:hover {
                background-color: var(--day-content-bg-color-hover)
            }

        .vc-day-content:hover.vc-is-dark[data-v-47ef1cd6] {
            background-color: var(--day-content-dark-bg-color-hover)
        }

        .vc-day-content[data-v-47ef1cd6]:focus {
            background-color: var(--day-content-bg-color-focus)
        }

        .vc-day-content:focus.vc-is-dark[data-v-47ef1cd6] {
        ...
        .vc-highlight.vc-highlight-base-middle[data-v-47ef1cd6] {
            width: 100%;
            border-radius: 0 !important;
            border-left-width: 0 !important;
            border-right-width: 0 !important;
        ...
        .vc-dots[data-v-47ef1cd6] {
            display: flex;
            justify-content: center;
            align-items: center
        }

        .vc-dot[data-v-47ef1cd6] {
            ...
            .vc-dot[data-v-47ef1cd6]:not(:last-child) {
                margin-right: var(--dot-spacing)
            }

        .vc-bars[data-v-47ef1cd6] {
            display: flex;
            justify-content: flex-start;
            align-items: center;
    ...
    <style type="text/css">
        ...
        .vc-horizontal-divider[data-v-d137fa42] {
            align-self: center
        }
        ...
        .vc-header.align-left[data-v-d137fa42] {
            order: -1;
            justify-content: flex-start
        }

        .vc-header.align-right[data-v-d137fa42] {
            order: 1;
            justify-content: flex-end
        }

        .vc-title-layout[data-v-d137fa42] {
            display: flex;
            justify-content: center;
            align-items: center;
            flex-grow: 1
        ...
        .vc-title-layout.align-left[data-v-d137fa42] {
            justify-content: flex-start
        }

        .vc-title-layout.align-right[data-v-d137fa42] {
            justify-content: flex-end
        }

        .vc-title-wrapper[data-v-d137fa42] {
            position: relative
        }
        ...
        .vc-title[data-v-d137fa42], .vc-weekday[data-v-d137fa42] {
            -webkit-user-select: none;
            -moz-user-select: none;
            -ms-user-select: none;
            user-select: none
    ...
    <style type="text/css">
        ...
        .slide-left-enter[data-v-5be4b00c], .slide-right-leave-to[data-v-5be4b00c] {
            transform: translateX(var(--slide-translate))
        }

        .slide-left-leave-to[data-v-5be4b00c], .slide-right-enter[data-v-5be4b00c] {
            transform: translateX(calc(-1*var(--slide-translate)))
        }

        .slide-down-leave-to[data-v-5be4b00c], .slide-up-enter[data-v-5be4b00c] {
            transform: translateY(var(--slide-translate))
        }

        .slide-down-enter[data-v-5be4b00c], .slide-up-leave-to[data-v-5be4b00c] {
    ...
    <style type="text/css">
        .vc-reset, .vc-reset * {
            ...
            .vc-reset [role=button], .vc-reset button {
                cursor: pointer
            }

        .vc-border, .vc-border-2, .vc-border-3 {
            border-style: solid
        }
        ...
        .vc-rounded-b, .vc-rounded-r {
            border-bottom-right-radius: 4px
        }

        .vc-rounded-b, .vc-rounded-l {
    ...
    <script charset="utf-8" src="./Бронев_files/1671459199385-chunk-5416c207.0724c0c22d511bcd7098.js"></script>
</head>
            ...
            <div id="main-wrapper">
                <header class="topbar">
                    <nav class="navbar top-navbar navbar-expand-md navbar-light">
                        <div class="navbar-header"><a class="navbar-brand"><b><img src="./Бронев_files/logo-light-icon.png" alt="homepage" class="light-logo"></b><span style="display: none;"><img src="./Бронев_files/logo-light-text.png" alt="homepage" class="light-logo"></span></a></div><div class="navbar-collapse">
                            <ul class="navbar-nav mr-auto mt-md-0">
                                ...
                                <li class="nav-item">
                                    <a target="_self" class="nav-link waves-effect waves-dark">
                                        Продажи
                                    </a>
                                </li>
                                <li class="nav-item"><!----></li>
                                <div class="dropdown b-dropdown btn-group" id="__BVID__124">
                                    <!----><button aria-haspopup="true" aria-expanded="false" type="button" class="btn dropdown-toggle btn-link btn-lg text-decoration-none text-light dropdown-toggle-no-caret" id="__BVID__124__BV_toggle_">Отчёты</button><ul role="menu" tabindex="-1" class="dropdown-menu" aria-labelledby="__BVID__124__BV_toggle_">
                                        <!----><!---->
                                        <li role="presentation">
                                            <a role="menuitem" target="_self" href="https://bronew.ru/#" class="dropdown-item">
                                                <a href="https://bronew.ru/cashier_report" class="">
                                                    Полный для кассиров
                                                </a>
                                            </a>
                                        </li>
                                        <li role="presentation">
                                            <a role="menuitem" target="_self" href="https://bronew.ru/#" class="dropdown-item">
                                                <a href="https://bronew.ru/tickets_report" class="">
                                                    Билетная ведомость
                                                </a>
                                            </a>
                                        </li>
                                        <li role="presentation">
                                            <a role="menuitem" target="_self" href="https://bronew.ru/#" class="dropdown-item">
                                                <a href="https://bronew.ru/short_tickets_report" class="">
                                                    Краткая билетная ведомость
                                                </a>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                            </ul><div class="dropdown b-dropdown btn-group" id="__BVID__30">
                                <!----><button aria-haspopup="true" aria-expanded="false" type="button" class="btn dropdown-toggle btn-link btn-lg text-decoration-none dropdown-toggle-no-caret" id="__BVID__30__BV_toggle_"><img alt="user" class="profile-pic" src="./Бронев_files/bytkjhV923KVA.jpg"></button><ul role="menu" tabindex="-1" class="dropdown-menu dropdown-menu-right" aria-labelledby="__BVID__30__BV_toggle_">
                                    <li role="presentation">
                                        <header role="heading" class="dropdown-header">
                                            <div class="dw-user-box">
                                                <div class="u-img"><img alt="user" src="./Бронев_files/bytkjhV923KVA.jpg"></div><div class="u-text">
                                                    <h6>Турист Т.Т.</h6><p class="text-muted">kassa13@translux.ru</p><a href="https://bronew.ru/user/110" class="btn btn-rounded btn-danger btn-sm">
                                                        Просмотреть
                                                        профиль
                                                    </a>
                                                </div>
                ...
                </header><aside class="left-sidebar" style="overflow: visible;">
                    <div class="slimScrollDiv" style="position: relative; overflow: visible; width: auto; height: 100%;">
                        <div class="scroll-sidebar" style="overflow: visible hidden; width: auto; height: 100%;">
                            <div class="user-profile" style="background: url(&quot;/images/background/user-info.jpg&quot;) no-repeat;">
                                <div class="profile-img"><img alt="user" src="./Бронев_files/bytkjhV923KVA.jpg"></div><div class="dropdown b-dropdown profile-text btn-group" id="__BVID__35">
                                    <!----><button aria-haspopup="true" aria-expanded="false" type="button" class="btn dropdown-toggle btn-link btn-sm text-decoration-none" id="__BVID__35__BV_toggle_"><span class="user_l">Турист Т.Т.</span></button><ul role="menu" tabindex="-1" class="dropdown-menu animated flipInY" aria-labelledby="__BVID__35__BV_toggle_">
                                        <li role="presentation" class="item">
                                            <a role="menuitem" target="_self" href="https://bronew.ru/#" class="dropdown-item">
                                                <a href="https://bronew.ru/user/110" class="ti-user" style="color: black;">
                                                    Профиль
                                                </a>
                                            </a>
                                        </li>
                                ...
                                <ul id="sidebarnav">
                                    ...
                                    <li><!----><ul id="collapse-1" class="collapse" style="display: none;"><ul><li><!----></li><li><!----></li><li><!----></li><li><!----></li><li><a href="https://bronew.ru/people" class="">Пассажиры</a></li><li><!----></li><li><!----></li><li><!----></li><li><!----></li><li><!----></li><li><!----></li><li><!----></li><li><!----></li><li><a href="https://bronew.ru/country" class="">Страны</a></li><li><a href="https://bronew.ru/city" class="">Города</a></li></ul></ul></li>
                                    <li><!----><ul id="collapse-8" class="collapse" style="display: none;"><ul><li><a href="https://bronew.ru/discount/create" class="">Создание</a></li><li><a href="https://bronew.ru/discount" class="">Управление</a></li></ul></ul></li>
                                    <li><!----><ul id="collapse-2" class="collapse" style="display: none;"><ul><li><a href="https://bronew.ru/user/create" class="">Создание</a></li><li><a href="https://bronew.ru/user" class="">Управление</a></li></ul></ul></li>
                                    <li><!----><ul id="collapse-5" class="collapse" style="display: none;"><ul><li><a href="https://bronew.ru/order" class="">Просмотр</a></li></ul></ul></li>
                                    <li><!----><ul id="collapse-3" class="collapse" style="display: none;"><ul><li><a href="https://bronew.ru/templates" class="">Шаблоны</a></li><li><a href="https://bronew.ru/routes" class="">Маршруты</a></li></ul></ul></li>
                                    <li><a target="_self" href="https://bronew.ru/#" class="has-arrow waves-effect waves-dark collapsed" aria-controls="collapse-4" aria-expanded="false" role="button"><i class="mdi mdi-bus"></i><span class="hide-menu">Рейсы</span></a><ul id="collapse-4" class="collapse" style="display: none;"><ul><!----><li><a href="https://bronew.ru/sale" class="">Продажи</a></li></ul></ul></li>
                                    <li>
                                        <a target="_self" href="https://bronew.ru/#" class="has-arrow waves-effect waves-dark collapsed" aria-controls="collapse-6" aria-expanded="false" role="button"><i class="mdi mdi-file-document"></i><span class="hide-menu">Отчёты</span></a><ul id="collapse-6" class="collapse" style="display: none;">
                                            <ul>
                                                <li><!----></li>
                                                <li><!----></li>
                                                <li><a href="https://bronew.ru/cashier_report" class="">Полный для кассиров</a></li>
                                                <li><a href="https://bronew.ru/tickets_report" class="">Билетная ведомость</a></li>
                                                <li>
                                                    <a href="https://bronew.ru/short_tickets_report" class="">
                                                        Краткая билетная ведомость
                                                    </a>
                                    ...
                                    <li><!----><ul id="collapse-7" class="collapse" style="display: none;"><ul><li><a href="https://bronew.ru/mintransTickets" class="">Билеты</a></li><li><a href="https://bronew.ru/mintransDrivers" class="">Водители</a></li><li><a href="https://bronew.ru/mintransQuittance" class="">Квитанции</a></li></ul></ul></li><!---->
                                </ul>
                            </nav>
                        </div><div class="slimScrollBar" style="background: rgb(220, 220, 220); width: 5px; position: absolute; top: 0px; opacity: 0.4; display: none; border-radius: 7px; z-index: 999; left: 1px; height: 612px;"></div><div class="slimScrollRail" style="width: 5px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: rgb(51, 51, 51); opacity: 0.2; z-index: 998; left: 1px;"></div>
                    </div>
                </aside><div class="page-wrapper" style="min-height: 591px;">
                    <div class="container-fluid">
                        <div class="row page-titles"><div class="col-md-12 col-12 align-self-center"><h5 class="m-b-0 m-t-0 fs"><div class="row justify-content-md-left"><div class="col-lg-5">Продажи</div><div class="col-md-3"></div><div class="col-lg-3"></div></div></h5><ol class="breadcrumb"></ol></div></div><div id="flights">
                            <div>
                                <div class="card">
                                    <!----><!----><div class="card-body">
                                        <!----><!----><div class="row no-gutters"><div class="col-md-auto col-12"><span data-v-64ee1ddd=""><input data-v-64ee1ddd="" placeholder="Выберите дату" value="21.01.2023" type="input" class="form-control"><div data-v-88de91da="" data-v-64ee1ddd="" class="vc-popover-content-wrapper"><!----></div></span></div><div class="col"><button type="button" class="btn mr-1 ml-1 btn-light collapsed" aria-controls="collapse-legend" aria-expanded="false"><i class="fas fa-angle-double-down"></i></button><!----></div></div><div>
                                            <div id="collapse-legend" class="mt-2 collapse" style="display: none;">
                                                <div class="card">
                                                    <!----><!----><div class="card-body">
                                                        <!----><!----><p class="card-text">
                                                            <div class="row">
                                                                <div class="col-lg-7"><form class=""><fieldset class="form-group" id="__BVID__86"><!----><div tabindex="-1" role="group" class="bv-no-focus-ring"><div class="row"><div class="col"><input type="text" placeholder="Поиск по маршруту" class="form-control" id="__BVID__87"></div><div class="col"><input type="text" placeholder="Поиск по рейсу" class="form-control" id="__BVID__88"></div><div class="col"><div dir="auto" class="v-select form-control custom-form-control vs--single vs--searchable"><div class="vs__dropdown-toggle"><div class="vs__selected-options"> <input placeholder="Поиск по направлению" aria-label="Search for option" role="combobox" type="search" autocomplete="off" class="vs__search"></div> <div class="vs__actions"><button type="button" title="Clear selection" class="vs__clear" style="display: none;"><svg xmlns="http://www.w3.org/2000/svg" width="10" height="10"><path d="M6.895455 5l2.842897-2.842898c.348864-.348863.348864-.914488 0-1.263636L9.106534.261648c-.348864-.348864-.914489-.348864-1.263636 0L5 3.104545 2.157102.261648c-.348863-.348864-.914488-.348864-1.263636 0L.261648.893466c-.348864.348864-.348864.914489 0 1.263636L3.104545 5 .261648 7.842898c-.348864.348863-.348864.914488 0 1.263636l.631818.631818c.348864.348864.914773.348864 1.263636 0L5 6.895455l2.842898 2.842897c.348863.348864.914772.348864 1.263636 0l.631818-.631818c.348864-.348864.348864-.914489 0-1.263636L6.895455 5z"></path></svg></button> <svg xmlns="http://www.w3.org/2000/svg" width="14" height="10" role="presentation" class="vs__open-indicator"><path d="M9.211364 7.59931l4.48338-4.867229c.407008-.441854.407008-1.158247 0-1.60046l-.73712-.80023c-.407008-.441854-1.066904-.441854-1.474243 0L7 5.198617 2.51662.33139c-.407008-.441853-1.066904-.441853-1.474243 0l-.737121.80023c-.407008.441854-.407008 1.158248 0 1.600461l4.48338 4.867228L7 10l2.211364-2.40069z"></path></svg> <div class="vs__spinner" style="display: none;">Loading...</div></div></div> <!----></div></div></div><!----><!----><!----></div></fieldset><fieldset class="form-group" id="__BVID__93"><!----><div tabindex="-1" role="group" class="bv-no-focus-ring"><div class="row"><div class="col"><div dir="auto" class="v-select form-control custom-form-control vs--single vs--searchable"><div class="vs__dropdown-toggle"><div class="vs__selected-options"> <input placeholder="Выберите отправление" aria-label="Search for option" role="combobox" type="search" autocomplete="off" class="vs__search"></div> <div class="vs__actions"><button type="button" title="Clear selection" class="vs__clear" style="display: none;"><svg xmlns="http://www.w3.org/2000/svg" width="10" height="10"><path d="M6.895455 5l2.842897-2.842898c.348864-.348863.348864-.914488 0-1.263636L9.106534.261648c-.348864-.348864-.914489-.348864-1.263636 0L5 3.104545 2.157102.261648c-.348863-.348864-.914488-.348864-1.263636 0L.261648.893466c-.348864.348864-.348864.914489 0 1.263636L3.104545 5 .261648 7.842898c-.348864.348863-.348864.914488 0 1.263636l.631818.631818c.348864.348864.914773.348864 1.263636 0L5 6.895455l2.842898 2.842897c.348863.348864.914772.348864 1.263636 0l.631818-.631818c.348864-.348864.348864-.914489 0-1.263636L6.895455 5z"></path></svg></button> <svg xmlns="http://www.w3.org/2000/svg" width="14" height="10" role="presentation" class="vs__open-indicator"><path d="M9.211364 7.59931l4.48338-4.867229c.407008-.441854.407008-1.158247 0-1.60046l-.73712-.80023c-.407008-.441854-1.066904-.441854-1.474243 0L7 5.198617 2.51662.33139c-.407008-.441853-1.066904-.441853-1.474243 0l-.737121.80023c-.407008.441854-.407008 1.158248 0 1.600461l4.48338 4.867228L7 10l2.211364-2.40069z"></path></svg> <div class="vs__spinner" style="display: none;">Loading...</div></div></div> <!----></div></div><div class="col"><div dir="auto" class="v-select form-control custom-form-control vs--single vs--searchable"><div class="vs__dropdown-toggle"><div class="vs__selected-options"> <input placeholder="Выберите назначение" aria-label="Search for option" role="combobox" type="search" autocomplete="off" class="vs__search"></div> <div class="vs__actions"><button type="button" title="Clear selection" class="vs__clear" style="display: none;"><svg xmlns="http://www.w3.org/2000/svg" width="10" height="10"><path d="M6.895455 5l2.842897-2.842898c.348864-.348863.348864-.914488 0-1.263636L9.106534.261648c-.348864-.348864-.914489-.348864-1.263636 0L5 3.104545 2.157102.261648c-.348863-.348864-.914488-.348864-1.263636 0L.261648.893466c-.348864.348864-.348864.914489 0 1.263636L3.104545 5 .261648 7.842898c-.348864.348863-.348864.914488 0 1.263636l.631818.631818c.348864.348864.914773.348864 1.263636 0L5 6.895455l2.842898 2.842897c.348863.348864.914772.348864 1.263636 0l.631818-.631818c.348864-.348864.348864-.914489 0-1.263636L6.895455 5z"></path></svg></button> <svg xmlns="http://www.w3.org/2000/svg" width="14" height="10" role="presentation" class="vs__open-indicator"><path d="M9.211364 7.59931l4.48338-4.867229c.407008-.441854.407008-1.158247 0-1.60046l-.73712-.80023c-.407008-.441854-1.066904-.441854-1.474243 0L7 5.198617 2.51662.33139c-.407008-.441853-1.066904-.441853-1.474243 0l-.737121.80023c-.407008.441854-.407008 1.158248 0 1.600461l4.48338 4.867228L7 10l2.211364-2.40069z"></path></svg> <div class="vs__spinner" style="display: none;">Loading...</div></div></div> <!----></div></div><div class="col"><select class="custom-select" placeholder="Поиск по активности" id="__BVID__104"><option value="">Активные</option><option value="&amp;show_all=true">Все</option></select></div></div><!----><!----><!----></div></fieldset></form></div><div class="col-lg-5">
                                                                    <form class="">
                                                                        <fieldset class="form-group" id="__BVID__105"><!----><div tabindex="-1" role="group" class="bv-no-focus-ring"><div class="row"><div class="col"><span data-v-64ee1ddd=""><input data-v-64ee1ddd="" placeholder="Выберите период" value="" type="input" class="vc-appearance-none vc-text-base vc-text-gray-800 vc-bg-white vc-border vc-border-gray-400 vc-rounded vc-w-full vc-py-2 vc-px-3 vc-leading-tight focus:vc-outline-none focus:vc-shadow"><div data-v-88de91da="" data-v-64ee1ddd="" class="vc-popover-content-wrapper"><!----></div></span></div></div><!----><!----><!----></div></fieldset><fieldset class="form-group" id="__BVID__110">
                                                                            <!----><div tabindex="-1" role="group" class="bv-no-focus-ring">
                                                                                <div class="row">
                                                                                    <div class="col">
                                                                                        <button type="button" class="btn btn-danger btn-sm">
                                                                                            Сбросить
                                                                                        </button><button type="button" class="btn btn-primary ml-2 btn-sm">
                                                                                            Поиск
                                                                                        </button>
                                                                                    </div>
                                                                                </div><!----><!----><!---->
                                        ...
                                        </div><div class="sale-custom-table table-responsive">
                                        <?php
                                            ...
                                            echo '<table role="table" aria-busy="false" aria-colcount="7" class="table b-table table-sm" id="__BVID__111">
                                                
                                                <thead role="rowgroup" class=""><!----><tr role="row" class=""><th role="columnheader" scope="col" tabindex="0" aria-colindex="1" aria-sort="none" class="">Рейс<span class="sr-only"> (Click to sort Ascending)</span></th><th role="columnheader" scope="col" tabindex="0" aria-colindex="2" aria-sort="none" class="">Дата и время<span class="sr-only"> (Click to sort Ascending)</span></th><th role="columnheader" scope="col" tabindex="0" aria-colindex="3" aria-sort="none" class="">ТС<span class="sr-only"> (Click to sort Ascending)</span></th><th role="columnheader" scope="col" tabindex="0" aria-colindex="4" aria-sort="none" class="text-center">Свободно<span class="sr-only"> (Click to sort Ascending)</span></th><th role="columnheader" scope="col" tabindex="0" aria-colindex="5" aria-sort="none" class="text-center">Статус рейса<span class="sr-only"> (Click to sort Ascending)</span></th><th role="columnheader" scope="col" tabindex="0" aria-colindex="6" class="">Действия</th><th role="columnheader" scope="col" tabindex="0" aria-colindex="7" class="">Ведомости</th></tr></thead>
                                                <tbody role="rowgroup">';

                                                    while ($row = $results->fetchArray(SQLITE3_ASSOC)) {

                                                        echo '<tr role="row" tabindex="0" class=""> 
                                                        <td aria-colindex="1" role="cell" class=""><a href="Бронев_1.html"><b class="text-info">' . $row['trip'] .  '</b></a></td>
                                                        <td aria-colindex="2" role="cell" class="">' . $row['date_time'] . '</td>
                                                        <td aria-colindex="3" role="cell" class="">
                                                        ' . $row['vehicle'] . '
                                                        </td>
                                                        <td aria-colindex="4" role="cell" class="text-center">' . $row['free_seats'] . '</td>
